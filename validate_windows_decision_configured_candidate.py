#!/usr/bin/env python3
"""Validate a configured Decision candidate without materializing providers."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Validate a suite-bound configured Decision candidate without "
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 2
    print("WINDOWS_DECISION_CONFIGURED_CANDIDATE_VALID")
