#!/usr/bin/env python3
"""Validate a Status Monitor configured candidate without side effects."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Validate a suite-bound configured Status Monitor candidate "
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 2
    print("WINDOWS_STATUS_MONITOR_CONFIGURED_CANDIDATE_VALID")
