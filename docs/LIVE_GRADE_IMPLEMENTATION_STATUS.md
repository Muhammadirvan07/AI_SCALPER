...
11. Broker-neutral one-shot evidence shadow runner kini memiliki durable per-stage receipt,
    ...
    fix, memindahkan first boundary ke `2026-07-30T06:45:00+09:00`, mengikat
    schedule identity yang sama pada manifest/installer/health/contract, dan
    memakai root operator baru yang terikat commit. Root/transfer V6 dan V6.1
    wajib tidak diubah bila ada; ketiadaan path yang belum pernah dibuat tidak
    menjadi blocker.
