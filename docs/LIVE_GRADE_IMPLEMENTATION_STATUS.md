...
Validasi penuh terbaru pada 2026-07-30 menjalankan **2.368 test** normal dan
**2.356 test** optimized tanpa kegagalan pada development Mac; tiga test
platform-dependent dilewati pada mode normal dan 15 pada mode optimized.
Keduanya juga melewati 1.340 subtest.
...
terdiri dari tujuh file dan Execution allowlist 58 file. Ini menutup consumer
dependency gap, tetapi belum menyediakan signed provider-bound session
handoff, concrete 40-provider runtime, credential, central unlock, atau order.
