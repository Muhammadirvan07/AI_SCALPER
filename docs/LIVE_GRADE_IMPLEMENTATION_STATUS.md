...
11. Broker-neutral one-shot evidence shadow runner kini memiliki durable per-stage receipt,
    ...
    ke manifest, menolak file/direktori ekstra secara rekursif, dan memakai
    root operator baru yang terikat commit. Root gagal dan ketiga artefak
    transfer lama wajib tetap tidak diubah untuk forensic review.
