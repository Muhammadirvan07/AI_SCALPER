#!/usr/bin/env python3
"""Assemble one deny-only Windows LIVE Execution candidate."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Assemble one immutable Windows LIVE Execution configured "
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 2
    print("WINDOWS_LIVE_EXECUTION_CONFIGURED_CANDIDATE_ASSEMBLED")
