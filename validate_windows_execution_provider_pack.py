#!/usr/bin/env python3
"""Validate a Windows Execution provider pack without importing providers."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Validate an exact Windows Execution provider pack without "
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = validate_windows_execution_provider_pack(
        ...
        return 2
    print("WINDOWS_EXECUTION_PROVIDER_PACK_VALID")
