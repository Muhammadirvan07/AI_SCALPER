...
PROFILES={
 "finex":{"generated":{"acl_policy":"policies/runtime_acl_policy.json","cas_config":"configs/cas-responder.json","finex_cas_bindings":"configs/finex-cas-config-and-key-bindings.json","finex_cas_firewall":"configs/finex-cas-firewall.json","finex_fetcher_bindings":"configs/finex-fetcher-config-and-key-bindings.json","finex_fetcher_firewall":"configs/finex-fetcher-firewall.json"},"required":{"configs/public_keys/putra_authority.pub","v3/OPERATOR_ENTRY_LOADER.ps1","v3/STATUS_FINEX_PHASE_D.ps1","v3/ACTIVATE_FINEX_TRUSTED_UTC_CAS_RESPONDER.ps1","v3/ACTIVATE_FINEX_TRUSTED_UTC_FETCHER.ps1","v3/ACTIVATE_PHASE_B_V3_COMMON.ps1","v3/APPLY_FINEX_TRUSTED_UTC_ACCEPTANCE.ps1","v3/ATTEST_PHASE_B_INSTALLED_DISABLED.ps1","v3/INSTALL_FINEX_TRUSTED_UTC_CAS_RESPONDER.ps1","v3/INSTALL_FINEX_TRUSTED_UTC_FETCHER.ps1","v3/OPERATOR_BOOTSTRAP.ps1","v3/OPERATOR_PHASE_B.ps1","v3/PHASE_B_V3_WINDOWS.ps1","v3/PUBLISH_FINEX_TRUSTED_UTC_PHASE_C.ps1","v3/RUN_FINEX_TRUSTED_UTC_CAS_RESPONDER.ps1","v3/RUN_FINEX_TRUSTED_UTC_FETCHER.ps1","v3/finex_trusted_utc.py","v3/phase_b_asymmetric_v3.py","dependencies/live_runtime/windows_trusted_utc_continuity_acceptance.py","dependencies/live_runtime/windows_trusted_utc_continuity_cas_responder.py","dependencies/run_windows_trusted_utc_continuity_cas_responder.py"}},
 "putra":{"generated":{"acl_policy":"policies/runtime_acl_policy.json","producer_bindings":"configs/putra-producer-config-and-key-bindings.json","producer_config":"configs/producer.json","producer_firewall":"configs/putra-producer-firewall.json"},"required":{"configs/public_keys/finex_acceptance.pub","v3/OPERATOR_ENTRY_LOADER.ps1","v3/ACTIVATE_PHASE_B_V3_COMMON.ps1","v3/ACTIVATE_PUTRA_TRUSTED_UTC_PRODUCER.ps1","v3/ATTEST_PHASE_B_INSTALLED_DISABLED.ps1","v3/INSTALL_PUTRA_TRUSTED_UTC_PRODUCER.ps1","v3/OPERATOR_BOOTSTRAP.ps1","v3/OPERATOR_PHASE_B.ps1","v3/PHASE_B_V3_WINDOWS.ps1","v3/PUBLISH_FINEX_TRUSTED_UTC_PHASE_C.ps1","v3/RUN_PUTRA_TRUSTED_UTC_PRODUCER.ps1","v3/finex_trusted_utc.py","v3/phase_b_asymmetric_v3.py","dependencies/live_runtime/windows_trusted_utc_continuity_acceptance.py"}}}
