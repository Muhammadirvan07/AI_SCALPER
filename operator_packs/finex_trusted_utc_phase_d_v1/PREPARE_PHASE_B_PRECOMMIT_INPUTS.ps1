...
param(
 ...
 [Parameter(ParameterSetName='Finex',Mandatory=$true)][string]$CasPrecommitRoot,[Parameter(ParameterSetName='Finex',Mandatory=$true)][string]$CasEncodedCommand,
 [Parameter(ParameterSetName='Finex',Mandatory=$true)][string]$FetcherPrecommitRoot,[Parameter(ParameterSetName='Finex',Mandatory=$true)][string]$FetcherEncodedCommand,
 [Parameter(ParameterSetName='Putra',Mandatory=$true)][string]$ProducerPrecommitRoot,[Parameter(ParameterSetName='Putra',Mandatory=$true)][string]$ProducerEncodedCommand,
...
if($HostRole-eq'finex'){$arguments+=@('--cas-precommit',$CasPrecommitRoot,'--cas-encoded',$CasEncodedCommand,'--fetcher-precommit',$FetcherPrecommitRoot,'--fetcher-encoded',$FetcherEncodedCommand)}else{$arguments+=@('--producer-precommit',$ProducerPrecommitRoot,'--producer-encoded',$ProducerEncodedCommand)}
