...
SCHEMAS={"finex-phase-b-v3":("finex-phase-d-phase-b-input-v3",{"binding_sha256","cas","consumer_host_identity_sha256","expected_host_role","fetcher","host_identity_sha256","release_identity_sha256","release_inventory_sha256","schema_version","source_host_identity_sha256"}),"putra-phase-b-v3":("putra-phase-d-phase-b-input-v3",{"binding_sha256","consumer_host_identity_sha256","expected_host_role","host_identity_sha256","producer","release_identity_sha256","release_inventory_sha256","schema_version","source_host_identity_sha256"}),"finex-post-install-v3":("finex-phase-d-post-install-input-v3",{"cas","fetcher","schema_version"}),"putra-post-install-v3":("putra-phase-d-post-install-input-v3",{"producer","schema_version"})}
...
def load(kind,path):
 ...
 if value["expected_host_role"]!=expected_host or any(HASH.fullmatch(str(value[key])) is None for key in ("binding_sha256","consumer_host_identity_sha256","host_identity_sha256","release_identity_sha256","release_inventory_sha256","source_host_identity_sha256")) or value["consumer_host_identity_sha256"]==value["source_host_identity_sha256"] or value["host_identity_sha256"]!=(value["consumer_host_identity_sha256"] if expected_host=="finex" else value["source_host_identity_sha256"]):raise ValueError("schema")
 ...
 for name,_ in roles:
  ...
  if trust!={"consumer_host_identity_sha256":value["consumer_host_identity_sha256"],"expected_host_role":expected_host,"host_identity_sha256":value["host_identity_sha256"],"joint_binding_sha256":value["binding_sha256"],"release_identity_sha256":value["release_identity_sha256"],"release_inventory_sha256":value["release_inventory_sha256"],"source_host_identity_sha256":value["source_host_identity_sha256"]}:raise ValueError("trust_binding")
