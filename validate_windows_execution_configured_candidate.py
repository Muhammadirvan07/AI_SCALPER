#!/usr/bin/env python3
"""Validate a Windows Execution configured candidate without side effects."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Validate one immutable Windows Execution configured candidate "
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result = validate_windows_execution_configured_candidate(
        ...
        return 2
    print("WINDOWS_EXECUTION_CONFIGURED_CANDIDATE_VALID")
